 ...
 * IP黑白名单配置
 */
@Table(name = "rate_limit_ip_black_white")
@Getter
@Setter
@Entity
@SQLDelete(sql = "update rate_limit_ip_black_white set deleted = 1 where id = ?")
@SQLRestriction("deleted = 0")
public class IpBlackWhiteList extends BaseEntity {
    ...
    /**
     * IP地址或IP段 (例如: 192.168.1.1 或 192.168.1.0/24)
     */
